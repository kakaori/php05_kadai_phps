<section class="mt-8 bg-gray-100 dark:bg-gray-800 lg:py-12 lg:flex lg:justify-center">
    <div
        ...
        <div class="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">勝連VCへ投資する</h2>
            <p class="mt-4 text-gray-500 dark:text-gray-300">勝連VCは、社会問題を解決する企業へ投資をします。社会問題を解決する企業へ投資をしたい人は投資家へご登録ください。</p>
